"""Common utilities and global settings for the project.
"""
...
class GlobalSettings:
    ...
    GLOBAL_LOG_LEVEL : typing.Final[str]                         = "warning"
    CACHE_DIR        : typing.Final[pathlib.Path]                = pathlib.Path("~/.cache/radpsd").expanduser().resolve()
    # autopep8: on
